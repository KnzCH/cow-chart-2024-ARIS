...
if sheet_url:
    ...
    if cow_name:
        ...
        present_behaviors = data['behavior_index'].dropna().unique()
        filtered_behaviors = [behaviors[i] for i in present_behaviors if i != -1]
        
        filtered_data = data[data['behavior_index'].isin(present_behaviors)]
